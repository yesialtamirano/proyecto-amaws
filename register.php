  ...
  <body>
	<div class="container">
		...
		<div class="login-form">
			...
			<h1 class="text-center">AMAWS</h1> <br><br>
			...
			<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-register" role="form" id="register-form">
				...
				<button class="btn btn-block bt-login" href="index.php" type="submit" id="submit_btn" data-loading-text="Signing Up....">Sign Up</button>
			</form>
