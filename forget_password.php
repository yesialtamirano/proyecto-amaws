  ...
  <body>
	<div class="container">
		...
		<div class="login-form">
			<h1 class="text-center">AMAWS</h1><br><br><br>
			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" id="forgetpassword-form" method="post"  class="form-register" role="form">
				...
				<button class="btn btn-block bt-login" type="submit" id="submit_btn" data-loading-text="Resetting Password....">Reset Password</button>
			</form>
